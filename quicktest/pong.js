...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'pong.wast';
  var wasmBinaryFile = 'pong.wasm';
  var asmjsCodeFile = 'pong.temp.asm.js';
...
// {{PRE_LIBRARY}}
  ...
  function __ZN10GameEngine13GetSceneWidthEv() {
  Module['printErr']('missing function: _ZN10GameEngine13GetSceneWidthEv'); abort(-1);
  }

  function __ZN10GameEngine14GetSceneHeightEv() {
  Module['printErr']('missing function: _ZN10GameEngine14GetSceneHeightEv'); abort(-1);
  }

  function __ZN10GameEngine21SetClearSceneCallbackEPFvvE() {
  Module['printErr']('missing function: _ZN10GameEngine21SetClearSceneCallbackEPFvvE'); abort(-1);
  }

  function __ZN10GameEngine21SetDrawCircleCallbackEPFviiiiE() {
  Module['printErr']('missing function: _ZN10GameEngine21SetDrawCircleCallbackEPFviiiiE'); abort(-1);
  }

  function __ZN10GameEngine24SetDrawRectangleCallbackEPFviiiiE() {
  Module['printErr']('missing function: _ZN10GameEngine24SetDrawRectangleCallbackEPFviiiiE'); abort(-1);
  }

  function __ZN10GameEngine9AddObjectE10GameObject() {
  Module['printErr']('missing function: _ZN10GameEngine9AddObjectE10GameObject'); abort(-1);
  }

  function __ZN10GameEngine9DrawSceneEv() {
  Module['printErr']('missing function: _ZN10GameEngine9DrawSceneEv'); abort(-1);
  }

  function __ZN10GameEngineC1Eii() {
  Module['printErr']('missing function: _ZN10GameEngineC1Eii'); abort(-1);
  }

  function __ZN10GameEngineD1Ev() {
  Module['printErr']('missing function: _ZN10GameEngineD1Ev'); abort(-1);
  }

  function __ZN10GameObjectC1Effff() {
  Module['printErr']('missing function: _ZN10GameObjectC1Effff'); abort(-1);
  }

  function __ZN10GameObjectD1Ev() {
  Module['printErr']('missing function: _ZN10GameObjectD1Ev'); abort(-1);
  }

  function __ZN17MovableGameObjectC1Effff() {
  Module['printErr']('missing function: _ZN17MovableGameObjectC1Effff'); abort(-1);
  }

  function __ZN17MovableGameObjectD1Ev() {
  Module['printErr']('missing function: _ZN17MovableGameObjectD1Ev'); abort(-1);
  }
...
Module['wasmTableSize'] = 386;

Module['wasmMaxTableSize'] = 386;
