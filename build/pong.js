...
var ASM_CONSTS = [function() { jsFunctions.jsClearCanvas(); },
 function($0, $1, $2, $3) { jsFunctions.jsDrawRectangle($0, $1, $2, $3); },
 function($0, $1, $2) { jsFunctions.jsDrawCircle($0, $1, $2); }];
...
Module['wasmTableSize'] = 209;

Module['wasmMaxTableSize'] = 209;
...
Module["asm"] = asm;
var _MoveBall = Module["_MoveBall"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_MoveBall"].apply(null, arguments) };
